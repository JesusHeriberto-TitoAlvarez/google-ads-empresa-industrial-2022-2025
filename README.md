...
- Gestión real de campañas **Search** y **Performance Max**
- Segmentación y lectura por **ciudad y mercado**
- Optimización sostenida basada en **CTR, CPC y tendencia**
- Escalado controlado manteniendo eficiencia
- Reflexión profesional sobre **aprendizajes y decisiones**

Todas las métricas se presentan de forma **agregada y anonimizada**, priorizando el análisis y la toma de decisiones por sobre la exposición de datos sensibles.
...
## 👤 Perfil profesional
Este portafolio está orientado a roles relacionados con:
- Performance Marketing
- Growth Marketing
- Google Ads / Paid Search
- Optimización y escalado de campañas digitales

---

## 🔒 Nota de confidencialidad
Toda la información presentada ha sido **anonimizada y agregada**.  
No se incluyen IDs de cuenta, campañas, audiencias ni información propietaria.  
Este repositorio tiene fines **exclusivamente profesionales y de portafolio**.
